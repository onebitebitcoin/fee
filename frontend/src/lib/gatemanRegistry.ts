...
const GLOBAL: Record<string, GateItem[]> = {
  binance: [
    ...
    { label: '일일 출금 한도', desc: 'KYC Level 1 (Basic): $1,000,000/day, Level 2 (Advanced): $2,000,000/day, 미인증: 출금 불가', level: 'info' },
  ...
  okx: [
    ...
    { label: '일일 출금 한도', desc: 'KYC1(기본 인증): $5,000/day, KYC2(고급·얼굴인식 추가): $10,000,000/day', level: 'info' },
  ...
  bybit: [
    ...
    { label: '일일 출금 한도', desc: 'Level 1 (Standard): $1,000,000/day, Level 2 (Advanced): $2,000,000/day', level: 'info' },
  ],
  bitget: [
