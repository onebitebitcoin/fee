...
import {
  ArrowDown, ArrowLeft, ArrowRight, ArrowSquareOut, CaretDown, Coin, CurrencyDollar,
  Globe, House, Info, Lightning, TrendDown, Warning, Wallet,
...
import type { GlobalExchange } from './explorer/constants';
import {
  DOMESTIC_INFO, GLOBAL_INFO, RISK_LABEL, RISK_COLOR,
  SPRING_FAST, SPRING_SLOW, fmtKst, fmtAmountText,
} from './explorer/constants';
import {
  ExFavicon, SectionLabel, Chip, OptionCard, StepDots, LoadingScreen, GatemanPanel,
} from './explorer/ui';
...
function ExplorerShell() {
  const {
    ...
    network, setNetwork,
    swapSvc, setSwapSvc,
    liveKimp, kimpFetchedAt, kimpInfoOpen, setKimpInfoOpen,
    btcPrice,
    btcMethod, setBtcMethod,
    globalExitMethod, setGlobalExitMethod,
    liveRegistry, displaySats, showAltPaths, setShowAltPaths, withdrawalLimits,
    stepEndRef, scrollToStepEnd,
    snapshotKimp, domesticBtcKrw, koreaVolumeMap,
    domesticOptions, coinOptions, globalOptions, networkOptions,
    hasLightningPaths, globalSupportsLightning, swapServiceOptions,
    resultPath, altPaths, steps, stepIdx,
    handleSearch, handleBack, handleNext, reset,
  } = useExplorer();
